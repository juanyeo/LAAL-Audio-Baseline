...
parser.add_argument("--exp_path", type=str, default='/home/s2/juanyeo/laalaudio/data/esc50/esc_output', help="the root path of the experiment")

if __name__ == '__main__':
    args = parser.parse_args()
    mAP_list = []
    acc_list = []
    for fold in range(1, 6): # (1, 6)
    ...
    result = cum_result / 5
    np.savetxt(args.exp_path+'/total_result.csv', result, delimiter=',')
