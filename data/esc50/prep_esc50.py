...
print('Start ESC-50 Preparation')

if os.path.exists('/shared/s2/lab01/clab/ESC-50-master') == False:
    esc50_url = 'https://github.com/karoldvl/ESC-50/archive/master.zip'
    wget.download(esc50_url, out='/shared/s2/lab01/clab/')
    with zipfile.ZipFile('/shared/s2/lab01/clab/ESC-50-master.zip', 'r') as zip_ref:
        zip_ref.extractall('/shared/s2/lab01/clab/')
    os.remove('/shared/s2/lab01/clab/ESC-50-master.zip')

    # convert the audio to 16kHz
    base_dir = '/shared/s2/lab01/clab/ESC-50-master/'
    os.mkdir('/shared/s2/lab01/clab/ESC-50-master/audio_16k/')
    audio_list = get_immediate_files('/shared/s2/lab01/clab/ESC-50-master/audio')
...
for fold in [1,2,3,4,5]:
    base_path = os.path.abspath(os.getcwd()) + "/shared/s2/lab01/clab/ESC-50-master/audio_16k/"
    meta = np.loadtxt('/shared/s2/lab01/clab/ESC-50-master/meta/esc50.csv', delimiter=',', dtype='str', skiprows=1)
    train_wav_list = []
    eval_wav_list = []
    ...
    with open('./esc_train_data_'+ str(fold) +'.json', 'w') as f:
        json.dump({'data': train_wav_list}, f, indent=1)

    with open('./esc_eval_data_'+ str(fold) +'.json', 'w') as f:
