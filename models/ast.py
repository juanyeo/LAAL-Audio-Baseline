...
class ASTModel(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        fstride = cfg.AST.FSTRIDE
        tstride = cfg.AST.TSTRIDE
        input_fdim = 128
        input_tdim = cfg.AST.AUDIO_LENGTH
        imagenet_pretrain = cfg.AST.IMAGENET_PRETRAIN
        audioset_pretrain = cfg.AST.AUDIOSET_PRETRAIN
        model_size = 'base384'
        verbose = True
        ...
        if audioset_pretrain == False:
            ...
            if verbose == True:
                logger.info('frequncey stride={:d}, time stride={:d}'.format(fstride, tstride))
